...
void C_ConstantBuffer::MF_Set_ConstantBufferByData(void* _DataType, UINT _ByteWidth)		// void* 자료형은 어떤 것이든 받을 수 있는 만능; 유의! 윈도우의 WPARAM과 LPARAM과 유사! 향후, CPU및 GPU간의 병렬을 Lock하기 위한 것을 감안하여 새로운 설계를 해보는 것을 고려해보자
{
	// 데이터 전송용 구조체
